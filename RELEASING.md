...
git commit -m "Bump version to 1.2.2 for release"
git tag -a 1.2.2 -m "Release version 1.2.2
...
- Test installation: `pip install islenska==1.2.2`
- Verify abi3 wheels are available for multiple Python versions

## Expected Wheel Artifacts

For version 1.2.2, expect 8 wheels plus the source distribution.
One `cp39-abi3` wheel covers all CPython 3.9+ versions; PyPy support
is limited to PyPy 3.11 (`pp311`).

**Linux (x86_64):**
- `islenska-1.2.2-cp39-abi3-manylinux_2_24_x86_64.manylinux_2_28_x86_64.whl`
- `islenska-1.2.2-pp311-pypy311_pp73-manylinux_2_24_x86_64.manylinux_2_28_x86_64.whl`

**macOS (x86_64 + arm64):**
- `islenska-1.2.2-cp39-abi3-macosx_10_9_x86_64.whl`
- `islenska-1.2.2-cp39-abi3-macosx_11_0_arm64.whl`
- `islenska-1.2.2-pp311-pypy311_pp73-macosx_10_15_x86_64.whl`
- `islenska-1.2.2-pp311-pypy311_pp73-macosx_11_0_arm64.whl`

**Windows (AMD64):**
- `islenska-1.2.2-cp39-abi3-win_amd64.whl`
- `islenska-1.2.2-pp311-pypy311_pp73-win_amd64.whl`

**Source:**
- `islenska-1.2.2.tar.gz`
...
- Re-run the workflow if needed: `gh workflow run wheels.yml --ref 1.2.2`
...
- **Minor (1.2.2)**: New features, backward compatible
